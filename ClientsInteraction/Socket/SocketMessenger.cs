...
namespace MyStore.Server
{
    internal class SocketMessenger : IMessenger
    {
        ...
        public async Task<string> ReceiveMessageAsync()
        {
            ...
            {
                _logger.Exception(ex, "Receiving message failed from: {0}", _clientSocket.RemoteEndPoint);
                throw;
            }
        }
        ...
        public async Task SendMessageAsync(string message)
        {
            ...
            {
                _logger.Exception(ex, "Sending message failed to: {0}", _clientSocket.RemoteEndPoint);
                throw;
            }
        }
    }
